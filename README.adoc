...
Different organizations utilize different proceedings structures —
the agendas, minutes, attendance rolls, votes, and resolutions that
make up the published record of a formal meeting — but they are
similar in purpose and in the data elements provided.

The Edoxen information models aim to unify those data elements in a
common framework, allowing interoperability between publications
and the creation of stable references to meetings, agendas,
minutes, and the resolutions adopted.

This repository holds the *canonical* LutaML UML definition of the
model. The Ruby gem that implements it lives at
https://github.com/edoxen/edoxen[edoxen/edoxen] and mirrors
...
The Ruby gem at https://github.com/edoxen/edoxen[edoxen/edoxen]
